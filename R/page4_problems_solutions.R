...
page4_problems_solutions_ui <- function() {
  page_fluid(
    ...
    em("(singular fit),"),
    "amikoris a program nem tudja az összes paramétért becsülni. Ennek egy megoldása lehet a modell egyszerűsítése, amely során kevesebb random hatást becsülünk. A teljes random struktúrából először eltávolítjuk a random hatások. Ha ez sem elég, akkor a legkisebb varianciával rendelkező legmagasabb szintű random hatást távolítjuk el. Ez addig folyathatjuk, amig el nem érjük a minimális random struktúrát, ami általában az alanyonkénti random tengelymetszet lesz."),
